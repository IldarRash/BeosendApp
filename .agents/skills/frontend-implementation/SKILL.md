...
description: Implement an apps/admin screen (React+Vite) with a typed ApiClient method, a data hook, and components built on the design system. Use when adding or changing what the admin/manager sees on the web.
---
