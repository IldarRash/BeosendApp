...
export const miniappEn: Record<string, string> = {
  ...
  "miniapp.home.scheduleHint": "Month calendar of sessions — pick a day",
  ...
  // --- Training schedule: month calendar of bookable sessions ---
  "miniapp.schedule.title": "Training schedule",
  "miniapp.schedule.hint": "Pick a day to see its trainings and book.",
  "miniapp.schedule.navAria": "Switch month",
  "miniapp.schedule.prevMonth": "Previous month",
  "miniapp.schedule.nextMonth": "Next month",
  "miniapp.schedule.gridAria": "Training calendar for {month}",
  "miniapp.schedule.dayAria": "Day {day}, trainings: {count}",
