...
export const botEn: Record<string, string> = {
  ...
  "bot.myBookings.moreUpcoming": "Show more upcoming",
  "bot.myBookings.morePast": "Show more history",
  "bot.myBookings.kind.booking": "Training",
  "bot.myBookings.kind.court": "Court rental",
  "bot.myBookings.kind.individual-request": "Individual request",
  "bot.myBookings.kind.waitlist": "Waitlist",
  "bot.myBookings.recordStatus": "Status: {status}",
  "bot.myBookings.status.pending": "request received — awaiting confirmation",
  "bot.myBookings.status.confirmed": "confirmed",
  "bot.myBookings.status.waitlisted": "on the waitlist",
  "bot.myBookings.status.declined": "declined",
  "bot.myBookings.status.cancelled.client": "cancelled by you",
  "bot.myBookings.status.cancelled.staff": "cancelled by organizer",
  "bot.myBookings.status.cancelled.system": "cancelled",
  "bot.myBookings.status.cancelled": "cancelled",
  "bot.myBookings.status.attended": "attended",
  "bot.myBookings.status.no_show": "missed",
  "bot.myBookings.status.completed": "completed",
  "bot.myBookings.position": "Queue position: {position}",
  "bot.myBookings.courts": "Confirmed courts: {courts}",
  "bot.myBookings.courtCount": "Courts: {count}",
  "bot.myBookings.price": "Price: {price} RSD",
  "bot.myBookings.reason.unavailable": "Reason: unavailable {comment}",
  "bot.myBookings.reason.schedule-change": "Reason: schedule change {comment}",
  "bot.myBookings.reason.staff-unavailable": "Reason: staff unavailable {comment}",
  "bot.myBookings.reason.other": "Reason: {comment}",
  "bot.myBookings.next.wait": "Next step: wait for a decision.",
  "bot.myBookings.next.attend": "Next step: check the date and time.",
  "bot.myBookings.next.choose-another": "Next step: choose another option.",
  ...
  "bot.trainerConfirm.pickReason": "Choose a reason for declining:",
  "bot.trainerConfirm.reason.unavailable": "Unavailable",
  "bot.trainerConfirm.reason.schedule-change": "Schedule change",
  "bot.trainerConfirm.reason.staff-unavailable": "Staff unavailable",
  "bot.trainerConfirm.reason.other": "Other reason",
  "bot.trainerConfirm.commentPrompt": "Enter a decline comment (up to 500 characters).",
  "bot.trainerConfirm.addComment": "Add a comment",
  "bot.trainerConfirm.withoutComment": "Decline without comment",
  "bot.trainerConfirm.commentTooLong": "The comment must be at most 500 characters.",
