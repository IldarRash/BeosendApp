...
export const botSr: Record<string, string> = {
  ...
  "bot.myBookings.moreUpcoming": "Prikaži još predstojećih",
  "bot.myBookings.morePast": "Prikaži još istorije",
  "bot.myBookings.kind.booking": "Trening",
  "bot.myBookings.kind.court": "Iznajmljivanje terena",
  "bot.myBookings.kind.individual-request": "Individualni zahtev",
  "bot.myBookings.kind.waitlist": "Lista čekanja",
  "bot.myBookings.recordStatus": "Status: {status}",
  "bot.myBookings.status.pending": "zahtev je primljen — čeka potvrdu",
  "bot.myBookings.status.confirmed": "potvrđeno",
  "bot.myBookings.status.waitlisted": "na listi čekanja",
  "bot.myBookings.status.declined": "odbijeno",
  "bot.myBookings.status.cancelled.client": "otkazali ste",
  "bot.myBookings.status.cancelled.staff": "organizator je otkazao",
  "bot.myBookings.status.cancelled.system": "otkazano",
  "bot.myBookings.status.cancelled": "otkazano",
  "bot.myBookings.status.attended": "prisustvovano",
  "bot.myBookings.status.no_show": "izostanak",
  "bot.myBookings.status.completed": "završeno",
  "bot.myBookings.position": "Mesto u redu: {position}",
  "bot.myBookings.courts": "Potvrđeni tereni: {courts}",
  "bot.myBookings.courtCount": "Tereni: {count}",
  "bot.myBookings.price": "Cena: {price} RSD",
  "bot.myBookings.reason.unavailable": "Razlog: nema dostupnosti {comment}",
  "bot.myBookings.reason.schedule-change": "Razlog: promena rasporeda {comment}",
  "bot.myBookings.reason.staff-unavailable": "Razlog: osoblje nije dostupno {comment}",
  "bot.myBookings.reason.other": "Razlog: {comment}",
  "bot.myBookings.next.wait": "Sledeći korak: sačekajte odluku.",
  "bot.myBookings.next.attend": "Sledeći korak: proverite datum i vreme.",
  "bot.myBookings.next.choose-another": "Sledeći korak: izaberite drugu opciju.",
  ...
  "bot.trainerConfirm.pickReason": "Izaberite razlog odbijanja:",
  "bot.trainerConfirm.reason.unavailable": "Nema dostupnosti",
  "bot.trainerConfirm.reason.schedule-change": "Promena rasporeda",
  "bot.trainerConfirm.reason.staff-unavailable": "Osoblje nije dostupno",
  "bot.trainerConfirm.reason.other": "Drugi razlog",
  "bot.trainerConfirm.commentPrompt": "Unesite komentar za odbijanje (do 500 znakova).",
  "bot.trainerConfirm.addComment": "Dodaj komentar",
  "bot.trainerConfirm.withoutComment": "Odbij bez komentara",
  "bot.trainerConfirm.commentTooLong": "Komentar može imati najviše 500 znakova.",
