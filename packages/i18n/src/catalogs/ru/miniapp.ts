...
export const miniappRu: Record<string, string> = {
  ...
  "miniapp.individual.sentTitle": "Заявка сохранена",
  "miniapp.individual.sentBody": "Заявка ожидает подтверждения. О решении сообщим здесь.",
  ...
  "miniapp.court.sentBody": "Заявка ожидает подтверждения администратора. О решении сообщим здесь.",
  ...
  "miniapp.records.title": "Мои записи и заявки",
  "miniapp.records.upcoming": "Активные",
  "miniapp.records.past": "История",
  "miniapp.records.emptyUpcoming": "Нет активных записей и заявок",
  "miniapp.records.emptyPast": "История пока пуста",
  "miniapp.records.loadMore": "Показать ещё",
  "miniapp.records.kind.booking": "Тренировка",
  "miniapp.records.kind.court": "Аренда корта",
  "miniapp.records.kind.individual-request": "Индивидуальная заявка",
  "miniapp.records.kind.waitlist": "Лист ожидания",
  "miniapp.records.status.pending": "Заявка получена — ожидает подтверждения",
  "miniapp.records.status.confirmed": "Подтверждено",
  "miniapp.records.status.waitlisted": "В листе ожидания",
  "miniapp.records.status.declined": "Заявка отклонена",
  "miniapp.records.status.cancelled": "Отменено",
  "miniapp.records.status.attended": "Посещено",
  "miniapp.records.status.no_show": "Пропуск",
  "miniapp.records.status.completed": "Завершено",
  "miniapp.records.reason": "Причина: {reason}",
  "miniapp.records.actor.client": "Отменено вами",
  "miniapp.records.actor.staff": "Решение сотрудника",
  "miniapp.records.actor.system": "Изменено системой",
  "miniapp.records.next.wait": "Ждите решения; повторно подавать заявку не нужно.",
  "miniapp.records.next.attend": "Проверьте дату и время.",
  "miniapp.records.next.choose-another": "Выберите другой вариант.",
  "miniapp.records.position": "Позиция в очереди: {position}",
  "miniapp.records.courts": "Корты: {courts}",
  "miniapp.records.reasonCode.unavailable": "Нет доступности",
  ...
  "miniapp.week.tab.schedule": "Расписание",
  "miniapp.week.tab.records": "Мои записи",
  "miniapp.week.tab.profile": "Профиль",
  "miniapp.week.title": "Моя неделя",
  "miniapp.week.weekAria": "Неделя",
  "miniapp.week.mine": "Мои планы",
  "miniapp.week.allTrainings": "Все тренировки",
  "miniapp.week.agendaAria": "Планы на неделю",
  "miniapp.week.emptyTitle": "На этой неделе пока нет планов",
  "miniapp.week.emptyBody": "Выберите тренировку или отправьте запрос.",
  "miniapp.week.partialTitle": "Показана не вся неделя",
  "miniapp.week.partialBody": "Загрузите ещё записи, чтобы проверить все планы на эту неделю.",
  "miniapp.week.recordsNudge": "Не теряйте заявки",
  "miniapp.week.recordsBody": "Подтверждения, отказы и причины — в «Моих записях».",
  "miniapp.week.recordsAction": "Открыть мои записи",
  "miniapp.week.fullCalendarAction": "Открыть полный календарь",
  "miniapp.week.groupAction": "Группа на месяц",
  "miniapp.week.individualAction": "Индивидуально с тренером",
  "miniapp.week.addTraining": "Добавить занятие",
  "miniapp.week.scheduleTitle": "Когда играем?",
  "miniapp.week.trainings": "Тренировки",
  "miniapp.week.courts": "Аренда кортов",
  "miniapp.week.today": "Сегодня",
  "miniapp.week.levelFilter": "Уровень",
  "miniapp.week.anyLevel": "Любой уровень",
  "miniapp.week.timeFilter": "Время",
  "miniapp.week.anyTime": "Любое время",
  "miniapp.week.sessionsTitle": "Занятия на день",
  "miniapp.week.noSessionsTitle": "На этот день занятий нет",
  "miniapp.week.noSessionsBody": "Попробуйте другой день или фильтр.",
  "miniapp.week.unavailable": "Недоступно",
