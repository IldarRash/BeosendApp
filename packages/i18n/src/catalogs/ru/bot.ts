...
export const botRu: Record<string, string> = {
  ...
  "bot.myBookings.moreUpcoming": "Показать ещё предстоящие",
  "bot.myBookings.morePast": "Показать ещё историю",
  "bot.myBookings.kind.booking": "Тренировка",
  "bot.myBookings.kind.court": "Аренда корта",
  "bot.myBookings.kind.individual-request": "Индивидуальная заявка",
  "bot.myBookings.kind.waitlist": "Лист ожидания",
  "bot.myBookings.recordStatus": "Статус: {status}",
  "bot.myBookings.status.pending": "заявка получена — ожидает подтверждения",
  "bot.myBookings.status.confirmed": "подтверждено",
  "bot.myBookings.status.waitlisted": "в листе ожидания",
  "bot.myBookings.status.declined": "отклонено",
  "bot.myBookings.status.cancelled.client": "отменено вами",
  "bot.myBookings.status.cancelled.staff": "отменено организатором",
  "bot.myBookings.status.cancelled.system": "отменено",
  "bot.myBookings.status.cancelled": "отменено",
  "bot.myBookings.status.attended": "посещено",
  "bot.myBookings.status.no_show": "пропуск",
  "bot.myBookings.status.completed": "завершено",
  "bot.myBookings.position": "Позиция в очереди: {position}",
  "bot.myBookings.courts": "Подтверждённые корты: {courts}",
  "bot.myBookings.courtCount": "Кортов: {count}",
  "bot.myBookings.price": "Цена: {price} RSD",
  "bot.myBookings.reason.unavailable": "Причина: нет доступности {comment}",
  "bot.myBookings.reason.schedule-change": "Причина: изменение расписания {comment}",
  "bot.myBookings.reason.staff-unavailable": "Причина: сотрудник недоступен {comment}",
  "bot.myBookings.reason.other": "Причина: {comment}",
  "bot.myBookings.next.wait": "Следующий шаг: ждите решения.",
  "bot.myBookings.next.attend": "Следующий шаг: проверьте дату и время.",
  "bot.myBookings.next.choose-another": "Следующий шаг: выберите другой вариант.",
  "bot.myBookings.next.none": "",
  ...
  "bot.trainerConfirm.pickReason": "Выберите причину отказа:",
  "bot.trainerConfirm.reason.unavailable": "Нет доступности",
  "bot.trainerConfirm.reason.schedule-change": "Изменение расписания",
  "bot.trainerConfirm.reason.staff-unavailable": "Сотрудник недоступен",
  "bot.trainerConfirm.reason.other": "Другая причина",
  "bot.trainerConfirm.commentPrompt": "Введите комментарий к отказу (до 500 символов).",
  "bot.trainerConfirm.addComment": "Добавить комментарий",
  "bot.trainerConfirm.withoutComment": "Отклонить без комментария",
  "bot.trainerConfirm.commentTooLong": "Комментарий должен быть не длиннее 500 символов.",
